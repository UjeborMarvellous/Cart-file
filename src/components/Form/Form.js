...
const Form = () => {
    return (
      <div className="">
        ...
        {/* form design start */}
        <form action="/Login" className="w-full max-w-sm block mx-auto mt-16 border-2 border-blue-400 py-6 px-8 rounded-2xl">
          ...
          <div className="md:flex md:items-center mb-6">
            ...
            <label className="md: block text-gray-500 font-bold">
              <span className="text-sm">
                Already Have an account <Link className="text-blue-500 underline capitalize" to="Login">Login</Link>
              </span>
            </label>
          </div>
